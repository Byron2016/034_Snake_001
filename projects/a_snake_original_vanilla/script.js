  ...
  collision(snake) {
    ...
    if (distance < snake.radio + this.radio) {
      this.position = {
        x:
          Math.floor(
            Math.random() * (canvas.width - this.radio - this.radio + 1),
          ) + this.radio,
        y:
          Math.floor(
            Math.random() * (canvas.height - this.radio - this.radio + 1),
          ) + this.radio,
      }
      snake.createBody()
      scoreP++
...
class Snake {
  ...
  createBody() {
    ...
    if (this.pathLength < 8) {
      this.body.push(
        new SnakeBody(this.radio, this.color, this.context, [...path]),
      )
      this.body.push(
        new SnakeBody(this.radio, this.color, this.context, [...path]),
      )
