...
function drawEye({
  ...
  if(dir[0] === DIRECTIONS[38][0] && dir[1] === DIRECTIONS[38][1]){
    ...
    eye_prop.EYE_SCLERA_DESP = {...eye_prop.EYE_DESP_DIR.DIR_UP.EYE_SCLERA_DESP};
    ...
    eye_prop.EYE_SCLERA_DESP = {...eye_prop.EYE_DESP_DIR.DIR_DOWN.EYE_SCLERA_DESP};
    eye_prop.EYE_IRIS_DESP = {...eye_prop.EYE_DESP_DIR.DIR_DOWN.EYE_IRIS_DESP};
    eye_prop.EYE_PUPIL_DESP = {...eye_prop.EYE_DESP_DIR.DIR_DOWN.EYE_PUPIL_DESP};
  }
  else if(dir[0] === DIRECTIONS[37][0] && dir[1] === DIRECTIONS[37][1]){
    // LEFT
    //console.log(`inside direc[37]`)
    
    eye_prop.EYE_SCLERA_DESP = {...eye_prop.EYE_DESP_DIR.DIR_LEFT.EYE_SCLERA_DESP};
    eye_prop.EYE_IRIS_DESP = {...eye_prop.EYE_DESP_DIR.DIR_LEFT.EYE_IRIS_DESP};
    eye_prop.EYE_PUPIL_DESP = {...eye_prop.EYE_DESP_DIR.DIR_LEFT.EYE_PUPIL_DESP};
  }
  else if(dir[0] === DIRECTIONS[39][0] && dir[1] === DIRECTIONS[39][1]){
    // RIGHT
    //console.log(`entro direc[39]`)

    eye_prop.EYE_SCLERA_DESP = {...eye_prop.EYE_DESP_DIR.DIR_RIGHT.EYE_SCLERA_DESP};
    eye_prop.EYE_IRIS_DESP = {...eye_prop.EYE_DESP_DIR.DIR_RIGHT.EYE_IRIS_DESP};
    eye_prop.EYE_PUPIL_DESP = {...eye_prop.EYE_DESP_DIR.DIR_RIGHT.EYE_PUPIL_DESP};
  }
  else {
    console.log(`There are a problem with eyes asignacion with concordanse with snake direction.`)
    return
  }
